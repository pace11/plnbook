...
<div class="login-box">
  ...
  <div class="login-logo"><i class="fa fa-flash"></i> <b>PLN</b> BOOKING APPS</div>
  ...
  <div class="login-box-body">
    ...
    <form action="login.php" method="post">
      ...
      <p align="center">PLN BOOKING | <b>Ver 1.0.0</b></p>
      ...
      if (isset($_POST['username']) && isset($_POST['password'])){
        ...
        $cek1       = mysqli_query($koneksi, "SELECT * FROM tbl_admin 
