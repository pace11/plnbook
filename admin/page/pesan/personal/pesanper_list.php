...
<div class="col-xs-12">
  <div class="box box-warning">
    <div class="box-header with-border">
      <h3 class="box-title"><b>PESAN Personal</b> | List</h3>
    ...
    <div id="modal_tambah" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="?tampil=pesanper_tambahpro" method="POST" name="modal_popup" enctype="multipart/form-data"
            class="form-horizontal">
                
                <input type="hidden" name="id" value="<?= $kode_otomatis ?>">
                <div class="form-group">
                  <label class="label-control col-md-3">MITRA PLN</label>
                  <div class="col-md-8">
                    <select class="form-control" name="mitrapln">
