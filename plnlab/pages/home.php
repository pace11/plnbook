          ...
          <div class="col-4">
            <div class="info-box">
              <div class="info-box-content">
                <span class="info-box-text"><p><?= $tampil['nama'] ?></p></span>
                <span class="info-box-number">
                 <a href="?page=home_detail&id_cat=<?= $tampil['id_category'] ?>" class="btn btn-success btn-sm"><i class="fa fa-check-square"></i> pilih</a>
                </span>
              </div>
              <!-- /.info-box-content -->
            </div>
