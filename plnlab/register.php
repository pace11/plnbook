...
<?php
    ...
    $carikode = mysqli_query($koneksi, "SELECT id_pelanggan FROM tbl_pelanggan") or die (mysqli_error($koneksi));
    ...
    $jumlah_data = mysqli_num_rows($carikode);
        if ($datakode) {
            ...
            $kode = (int) $nilaikode;
            $kode = $jumlah_data + 1;
            $kode_otomatis = "PELANGGAN".str_pad($kode, 3, "0", STR_PAD_LEFT);
        } else {
            $kode_otomatis = "PELANGGAN001";
        }
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-0">
        By registering you agree to the terms and conditions of <a href="plnlab.php">plnlab</a>
      </p>
      <p class="mb-0">
